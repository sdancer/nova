module Test.TestExprRecord2 where
...
main :: Effect Unit
main = do
  log "=== Expr Record Test 2 ==="
  
  -- The exact sequence - using colon for record field
  let input = """x
{ b: c }"""
  ...
  -- Now the actual failing case - using actual colon delimiter
  log ""
  log "With = after the record:"
  let input2 = """x
{ b: c } = y"""
